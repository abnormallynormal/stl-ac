...
export default function TeamPage({
  ...
  const availableTeachers = [
    ...
    "alexandra.defaveri@ycdsbk12.ca",
    "alla.al-shaikh@ycdsbk12.ca",
    "anthony.petrone@ycdsbk12.ca",
    "antonette.montanaro@ycdsbk12.ca",
    "brian.villaalvarez@ycdsbk12.ca",
    "catharina.wicks@ycdsbk12.ca",
    ...
    "lori.gennaro@ycdsbk12.ca",
    "lucy.araujo@ycdsbk12.ca",
    "manuel.deocampo@ycdsbk12.ca",
