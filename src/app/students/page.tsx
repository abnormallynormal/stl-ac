              ...
              <div className="flex flex-wrap gap-2">
                <div className="flex gap-2">
                  <Checkbox 
                    ...
                    onCheckedChange={(checked) => handleGradeFilterChange('nine', checked as boolean)}
                  />
                ...
                <div className="flex gap-2">
                  <Checkbox 
                    ...
                    onCheckedChange={(checked) => handleGradeFilterChange('ten', checked as boolean)}
                  />
                ...
                <div className="flex gap-2">
                  <Checkbox 
                    ...
                    onCheckedChange={(checked) => handleGradeFilterChange('eleven', checked as boolean)}
                  />
                ...
                <div className="flex gap-2">
                  <Checkbox 
                    ...
                    onCheckedChange={(checked) => handleGradeFilterChange('twelve', checked as boolean)}
                  />
              ...
              <div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <Checkbox 
                    ...
                    onCheckedChange={(checked) => setIncludeGraduated(checked as boolean)}
                  />
                </div>
              </div>
